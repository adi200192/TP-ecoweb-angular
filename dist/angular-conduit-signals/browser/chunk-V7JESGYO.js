...
// src/app/shared/services/static-content.service.ts
var _StaticContentService = class _StaticContentService {
  // MAUVAISE PRATIQUE: Charger la configuration du menu depuis un Observable
  // au lieu d'utiliser des constantes statiques
  getMenuConfiguration(isAuthenticated) {
...
_StaticContentService.\u0275fac = function StaticContentService_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || _StaticContentService)();
};
_StaticContentService.\u0275prov = /* @__PURE__ */ \u0275\u0275defineInjectable({ token: _StaticContentService, factory: _StaticContentService.\u0275fac, providedIn: "root" });
var StaticContentService = _StaticContentService;
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(StaticContentService, [{
    type: Injectable,
    args: [{
      providedIn: "root"
    }]
...
// src/app/shared/constants/paging.ts
var DEFAULT_LIMIT = 10;

// src/app/shared/constants/storage-key.ts
var STORAGE_KEY = {
  user: "userInfo"
};
...
var _httpClient;
var _ArticleService = class _ArticleService {
  constructor() {
    __privateAdd(this, _httpClient, inject(HttpClient));
  }
  createArticle(article) {
    return __privateGet(this, _httpClient).post("/articles", {
      article
    });
  }
  updateArticle(slug, article) {
    return __privateGet(this, _httpClient).put(`/articles/${slug}`, {
      article
    });
  }
  deleteArticle(slug) {
    return __privateGet(this, _httpClient).delete(`/articles/${slug}`);
  }
  getCommentsForArticle(slug) {
    return __privateGet(this, _httpClient).get(`/articles/${slug}/comments`);
  }
  createCommentForArticle(slug, comment) {
    return __privateGet(this, _httpClient).post(`/articles/${slug}/comments`, {
      comment
    });
  }
  deleteCommentForArticle(slug, id) {
    return __privateGet(this, _httpClient).delete(`/articles/${slug}/comments/${id}`);
  }
  getArticleDetail(slug) {
    return __privateGet(this, _httpClient).get(`/articles/${slug}`);
  }
  getFeed(request) {
    return __privateGet(this, _httpClient).get("/articles/feed", {
      params: __spreadValues({}, request)
    });
  }
  getArticleGlobal(request) {
    return __privateGet(this, _httpClient).get("/articles", {
      params: __spreadValues({}, request)
    });
  }
  favoriteArticle(slug) {
    return __privateGet(this, _httpClient).post(`/articles/${slug}/favorite`, {});
  }
  unfavoriteArticle(slug) {
    return __privateGet(this, _httpClient).delete(`/articles/${slug}/favorite`);
  }
};
_httpClient = new WeakMap();
_ArticleService.\u0275fac = function ArticleService_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || _ArticleService)();
};
_ArticleService.\u0275prov = /* @__PURE__ */ \u0275\u0275defineInjectable({ token: _ArticleService, factory: _ArticleService.\u0275fac, providedIn: "root" });
var ArticleService = _ArticleService;
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(ArticleService, [{
    type: Injectable,
    args: [{
      providedIn: "root"
    }]
...
// src/app/shared/services/user-and-authentication.service.ts
var _httpClient2;
var _UserAndAuthenticationService = class _UserAndAuthenticationService {
  constructor() {
    __privateAdd(this, _httpClient2, inject(HttpClient));
  }
  login(user) {
    return __privateGet(this, _httpClient2).post("/users/login", {
      user
    });
  }
  register(user) {
    return __privateGet(this, _httpClient2).post("/users", {
      user
    });
  }
  getCurrentUser() {
    return __privateGet(this, _httpClient2).get("/user");
  }
  updateCurrentUser(user) {
    return __privateGet(this, _httpClient2).put("/user", {
      user
    });
  }
};
_httpClient2 = new WeakMap();
_UserAndAuthenticationService.\u0275fac = function UserAndAuthenticationService_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || _UserAndAuthenticationService)();
};
_UserAndAuthenticationService.\u0275prov = /* @__PURE__ */ \u0275\u0275defineInjectable({ token: _UserAndAuthenticationService, factory: _UserAndAuthenticationService.\u0275fac, providedIn: "root" });
var UserAndAuthenticationService = _UserAndAuthenticationService;
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(UserAndAuthenticationService, [{
    type: Injectable,
    args: [{
      providedIn: "root"
    }]
...
// src/app/shared/services/title-strategy.service.ts
var _TitleStrategyService = class _TitleStrategyService extends TitleStrategy {
  constructor() {
    super(...arguments);
...
_TitleStrategyService.\u0275fac = /* @__PURE__ */ (() => {
  let \u0275TitleStrategyService_BaseFactory;
  return function TitleStrategyService_Factory(__ngFactoryType__) {
    return (\u0275TitleStrategyService_BaseFactory || (\u0275TitleStrategyService_BaseFactory = \u0275\u0275getInheritedFactory(_TitleStrategyService)))(__ngFactoryType__ || _TitleStrategyService);
  };
})();
_TitleStrategyService.\u0275prov = /* @__PURE__ */ \u0275\u0275defineInjectable({ token: _TitleStrategyService, factory: _TitleStrategyService.\u0275fac, providedIn: "root" });
var TitleStrategyService = _TitleStrategyService;
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(TitleStrategyService, [{
    type: Injectable,
    args: [{
      providedIn: "root"
    }]
...
var _ProfileService = class _ProfileService {
  constructor() {
    __privateAdd(this, _httpClient3, inject(HttpClient));
  }
  getProfile(username) {
    return __privateGet(this, _httpClient3).get(`/profiles/${username}`);
  }
  followUser(username) {
    return __privateGet(this, _httpClient3).post(`/profiles/${username}/follow`, {});
  }
  unfollowUser(username) {
    return __privateGet(this, _httpClient3).delete(`/profiles/${username}/follow`);
  }
};
_httpClient3 = new WeakMap();
...
// src/app/shared/utils/tap-response.operator.ts
function tapResponse(nextFn, errorFn, finalizeFn) {
  return (source) => {
    if (typeof nextFn === "function") {
      return source.pipe(tap(nextFn), catchError((error) => {
        if (errorFn) {
          errorFn(error);
        }
      ...
      return source.pipe(tap((value) => nextFn?.next?.(value)), catchError((error) => {
        nextFn?.error?.(error);
        return throwError(() => error);
...
@angular/router/fesm2022/router.mjs:
   ...
   *)
*/
//# sourceMappingURL=chunk-V7JESGYO.js.map
